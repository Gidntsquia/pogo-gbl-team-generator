...
import { hashSeed, makeScheduler, mulberry32 } from './battle/virtualClock.js';
import { createScenarioMemo, wrapRunScenario } from './battle/scenarioMemo.js';
import { orderWithLead, setReactionTime, wrapBattleClock } from './battle/clockWrappers.js';
import { wrapShieldBanking, wrapSwitchCost, wrapThrowAndGo } from './battle/aiWrappers.js';
...
export function battleTeams(ctx, params) {
  ...
  // flip (the variance study's "4|4|2|2" battle) showed the bench members'
